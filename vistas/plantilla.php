...
<head>
  ...
  <link rel="stylesheet" href="vistas/bower_components/css/slide.css">
  <link rel="stylesheet" href="vistas/bower_components/css/plantilla.css">
  <link rel="stylesheet" href="vistas/bower_components/css/cabezote.css">
  <link rel="stylesheet" href="vistas/bower_components/css/menu.css">
  <link rel="stylesheet" href="vistas/bower_components/css/login.css">
  ...
  if (isset($_SESSION["validarSesion"]) && $_SESSION["validarSesion"] === "ok") {
    ...
    if (isset($_GET["ruta"])) {
      ...
      if (
        ...
        $_GET["ruta"] == "perfiles" ||
        $_GET["ruta"] == "perfil" ||
        $_GET["ruta"] == "grupo-etario" ||
        $_GET["ruta"] == "texto" ||
        $_GET["ruta"] == "preguntas" ||
        $_GET["ruta"] == "alternativas" ||
